...
public class LeaderboardActivity  extends AppCompatActivity  implements DBConnection{
    ...
    public  void onTaskCompleted (ArrayList <String> result)
    {
        ...
        if(var.equals("Problem getting info"))
        {
            ...
            for(String user:result){
                ...
                rowTextViews.setText(userdata[0]);
                rowTextViews.setLayoutParams(new LinearLayout.LayoutParams(0,LinearLayout.LayoutParams.MATCH_PARENT,0.40f));
                rowTextViews.setTextColor(Color.WHITE);
                rowTextViews.setTextSize(20);
                rowTextViews.setPadding(20,20,20,20);

                rowTextViews2.setText(userdata[1]);
                rowTextViews2.setLayoutParams(new LinearLayout.LayoutParams(0,LinearLayout.LayoutParams.MATCH_PARENT,0.20f));
                rowTextViews2.setTextColor(Color.WHITE);
                rowTextViews2.setTextSize(20);
                rowTextViews2.setPadding(20,20,20,20);
